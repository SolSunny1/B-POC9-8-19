...
*   SS: 1/16/20 Appended Category and TD based business logic
************************************************************************************************************************************/
trigger Contact_OwnerAssignment_LATEST on Contact_LATEST (after insert, after update) {
    ...
    if(Trigger.isInsert){
        ...
        for(contact c: Trigger.new){
            if(c.Do_Not_Auto_Update_Owner__c == false && ((c.SalesConnect__Rep_Status__c == 'Active' && c.SalesConnect__Category_1__c == null && c.SalesConnect__Category_2__c == null ) ||
            (c.SalesConnect__Category_1__c == 'Wealth Management'  && 
            (c.SalesConnect__Territory_Description_1__c == 'Central' || c.SalesConnect__Territory_Description_1__c == 'Mid-Atlantic' ||
            c.SalesConnect__Territory_Description_1__c == 'Mid-West' || c.SalesConnect__Territory_Description_1__c == 'Northeast' ||
            c.SalesConnect__Territory_Description_1__c == 'Southeast' || c.SalesConnect__Territory_Description_1__c == 'West'))) ){ //SS: 1-16-20 Appended Category and TD based business logic
    ...
    if(Trigger.isUpdate){
        for(contact new_c: Trigger.new){
            ...
            if(new_c.Do_Not_Auto_Update_Owner__c == false && ((new_c.SalesConnect__Rep_Status__c == 'Active' && new_c.SalesConnect__Category_1__c == null && new_c.SalesConnect__Category_2__c == null ) ||
            (new_c.SalesConnect__Category_1__c == 'Wealth Management'  && 
            (new_c.SalesConnect__Territory_Description_1__c == 'Central' || new_c.SalesConnect__Territory_Description_1__c == 'Mid-Atlantic' ||
            new_c.SalesConnect__Territory_Description_1__c == 'Mid-West' || new_c.SalesConnect__Territory_Description_1__c == 'Northeast' ||
            new_c.SalesConnect__Territory_Description_1__c == 'Southeast' || new_c.SalesConnect__Territory_Description_1__c == 'West'))) ){  //SS: 1-16-20 Appended Category and TD based business logic. SS: 6-27-19 moved this if statement before below old_c line. 
    ...
    if(setStates.size() > 0 || setZips.size() >0 ){    
        ...
        for(contact c: Trigger.new){
            ...
            (c.SalesConnect__Territory_Description_1__c == 'Central' || c.SalesConnect__Territory_Description_1__c == 'Mid-Atlantic' ||
            c.SalesConnect__Territory_Description_1__c == 'Mid-West' || c.SalesConnect__Territory_Description_1__c == 'Northeast' ||
            c.SalesConnect__Territory_Description_1__c == 'Southeast' || c.SalesConnect__Territory_Description_1__c == 'West'))) ){   ////SS: 1-16-20 Appended Category and TD based business logic. SS: 6-27-19 appended this if statement before collection statement below to bypass contacts with do not auto update flag. 
